...
<br>
            ...
            <div class="deacon">
                ...
                <div id="deaconPackage" class="container">
                  ...
                  <h1 id="standOut">Vicar Package- Small Congregation (6 Total Pages)</h1>
                  <p class="lead1">
                      <h3>Your Vicar Package you will have three pages on the navigation bar: Home, About Us, and Contact Us.
                  </p>
                  ...
                  <hr class="featurette-divider">
                    ...
                    <div class="churchPackages">
                        <div class="row">
                            <div class="col-md-6">
                                <div>
                                    <img src="/lib/images/churchPackages/deaconHome.JPG" alt="home" width="550" height="600">
                                </div>
                            </div>
                            <div class="col-md-6">
                  ...
                  <div class="churchPackages">
                      <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="lead">
                                  <h3>The About Us page helps you describe or identify your churches attributes.  You can use other titles such as; Welcome, Explore, etc.<br>
                            ...
                            <div class="col-md-6">
                                <img src="/lib/images/churchPackages/deaconAbout.JPG" alt="about" width=550"" height="600">
                          </div>
                    </div>
                  </div>
                </div>
                ...
                <div id="deaconPackage" class="container">
                    <div class="churchPackages">
                        <div class="row">
                            <div class="col-md-6">
                                <div>
                                    <img src="/lib/images/churchPackages/deaconContact.JPG" alt="contact" width=550"" height="600">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h2 id="standOut1">Contact Us Page</h2>
                                <p class="lead">
                                  <h3>The Contact Us page will help your visitors find your locations and give them options of how to contact you.
                ...
                <div id="deaconPackage" class="container">
                  <div class="churchPackages">
                      <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="/lib/images/churchPackages/deaconSub.JPG" alt="service" width=550"" height="600">
                            </div>
                        </div>
                    </div>
                </div>
