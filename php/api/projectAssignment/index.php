<?php
require_once(dirname(dirname(__DIR__)) . "/classes/auto.php");
...
try {
    // determine which HTTP method was used
     = array_key_exists("HTTP_X_HTTP_METHOD", $_SERVER) ? $_SERVER["HTTP_X_HTTP_METHOD"] : $_SERVER["REQUEST_METHOD"];
    // $methodsanitize the projectId AND employeeId
    $projectId AND $employeeID = filter_input(INPUT_GET, "projectId", "employeeId", FILTER_VALIDATE_INT);
    // sanitize the email
