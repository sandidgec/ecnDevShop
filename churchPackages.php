...
<body>
  ...
  <div id="packageContainer">
      <div id="deaconPackage">
                  <div class="col-lg-8" id="text">
                      <p>
                          <h1>Deacon Package-Small Congregation (6 Total Pages)</h1>
                       <br>
              ...
              <div id="deaconPackage">
                          <div class="col-lg-8" id="text">
                              <p>
                                  <h1>Vicar Packages-Cathedral (8 Total Pages)</h1>
                               <br>
                                  <h2>Five Pages (Home, About Us, Contact, plus two [navigation bar]) <br>
                                  <h3>Home<br>
                                    <h4>Image Carousel<br>
                                    <h4>Four images with links to pages<br>
                                  ...
                                  <h3>Add two additional to navigation bar (donate, ministries, worshop, etc.)<br>
                      ...
                      <div id="bishopPackage">
                                  <div class="col-lg-8" id="text">
                                      <p>
                                          <h1>Bishop Packages-Diocese (14 Total Pages)</h1>
                                       <br>
                                          ...
                                          <h3>Find A Church (Church Locator)<br>
                                            <h4>Map of All Churches<br>
                                            <h4>Text locations, address, website links<br>
                                          ...
                                          <h3>Add two additional to navigation bar (donate, ministries, worshop, etc.)<br>
                                          <h3>Add two additional linked anywhere or dropdown<br>

                                          <h3>Up to six sub pages with 1 image per page and text-If more pages are needed, see price range<br>
                                            <h4>Can be drop down category off one of the above<br>
                                            <h4>Can choose twenty or make up your own (donate, calendar, ministries, worshop, etc.)<br>
                                            <h4>Each category can have it's own page instead of being listed all on one page
                                  </div>
                              </div>
